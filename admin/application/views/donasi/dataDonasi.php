    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>Kampanye</h1>
                <ol class="breadcrumb">
                    <li><a href="../admin/Donasi"><i class="fa fa-file"></i>Kampanye</a></li>
                                    ...
                                    <tbody>
                                        ...
                                        <div id="demo" class="collapse">
                                                ...
                                                <td>
                                                    ...
                                                    <center>
                                                        <a href="<?php echo base_url('admin/Donasi/edit/' . $rows->id_donasi); ?>" onclick="return confirm(' Apakah anda yakin EDIT DATA DONASI ini ? ');"><i class="fa fa-edit fa-lg"></i></a>
                                                        <span class="spasi">
