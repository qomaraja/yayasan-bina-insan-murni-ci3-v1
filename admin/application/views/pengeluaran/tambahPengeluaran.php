    ...
    <div class="content-wrapper">
      ...
      <section class="content container-fluid">
        <div class="col-md-5 col-md-offset-3">
          ...
          <form action="<?php echo base_url('admin/Pengeluaran/create'); ?>" method="post" class="chart-box">
            ...
            <div class="row">
              <div class="col-md-12">
                <fieldset class="form-group">
                  <label>Judul</label>
                  <input class="form-control" name="nama_pengeluaran" id="basicInput" type="text" required />
                </fieldset>
              </div>
            </div>
            <!-- <div class="row">
              <div class="col-md-12">
                <fieldset class="form-group">
                  ...
                  <input class="form-control" name="kategori_pengeluaran" id="basicInput" type="text" required />
                </fieldset>
              </div>
            </div> -->
            ...
            <div class="row">
              <div class="col-md-12">
                <fieldset class="form-group">
                  ...
                  <input class="form-control" name="perolehan_pengeluaran" id="maskMoney" placeholder="Rp." type="text" required />
                </fieldset>
              </div>
            </div>
            <div class="row">
            ...
            <div class="row">
              <div class="col-md-12">
                <fieldset class="form-group">
                  ...
                  <textarea class="form-control" name="deskripsi_pengeluaran" id="basicInput" type="text" required></textarea>
                </fieldset>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <fieldset class="form-group">
                  <label>Gambar</label>
                  <input class="form-control-file" name="img" id="basicInput" type="file" accept="image/x-png,image/gif,image/jpeg" />
                </fieldset>
              </div>
            </div>
            <!-- <div class="row">
