...
<head>
  ...
  <?php $this->load->view('layout/meta'); ?>
	<title>Home - Lembaga Manajemen Infaq</title>
	...
	<div class="row" id="city">
		<div class="section">
			<div class="col-md-12 text-center">
				<h5 class="font-purple font-bold font-xl">Lembaga Manajemen Infaq</h5>
					 ...
					 <img style="width: 300px; height: 250px;" src="<?php echo base_url('assets/'.$row->img1); ?>"/>
						...
						<div class="col-md-6">
							...
							<h4><span class="m-card_footer">&nbsp;<?php echo 'Rp.'.nominal($row->perolehan_donasi); ?></span></h4>
								<!-- <a href="<?php echo base_url('/donasi/detail/'.$row->id_donasi); ?>"  type="button"class="btn btn-outline-success btn-lg btn-block" role="button">Detail</a> -->
					 </div>
					<hr><hr><hr>
				</div> 
			</div>
